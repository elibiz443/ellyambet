    ...
    <div class="sticky top-24 h-fit">
      ...
      <div class="grid sm:grid-cols-2 gap-12">
        <div>
          ...
          <p class="text-gray-400 text-sm mb-6">Tailored software solutions for high performance.</p>
          <a href="#" class="text-brand font-bold flex items-center gap-2 hover:text-white transition group">
            More Information
            <svg class="group-hover:translate-x-1 transition" width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg>
          </a>
        </div>
        <div>
          <h4 class="text-xl font-bold mb-4">Secure Infrastructure</h4>
          <p class="text-gray-400 text-sm mb-6">Ensure stability and reliability across systems.</p>
          <a href="#" class="text-brand font-bold flex items-center gap-2 hover:text-white transition group">
            More Information
            <svg class="group-hover:translate-x-1 transition" width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg>
          </a>
